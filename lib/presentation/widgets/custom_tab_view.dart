          ...
          children: [
            ...
            Expanded(
              child: TabBar(
                ...
                labelStyle:
                    titleMedium.copyWith(fontSize: 14, fontWeight: FontWeight.w700),
                unselectedLabelStyle: titleMedium.copyWith(fontSize: 14, fontWeight: FontWeight.w400),
                unselectedLabelColor: const Color(0xFF373737),
                tabs: List.generate(
                  widget.itemCount,
